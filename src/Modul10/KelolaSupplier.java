 ...
 * @author Pongo
 */
public class KelolaSupplier extends javax.swing.JFrame {
    ...
    private void LoadDataSupplier() {
        Object header[] = {"ID SUPPLIER", "KODE PEMBELIAN", "NAMA SUPPLIER", "NO. HP", "ALAMAT"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        jTable1.setModel(data);

        String sql = "SELECT id_supplier, kd_pembelian, nama_supplier, nohp_supplier, alamat FROM t_supplier";
        try {
    ...
    private void InputDataSupplier() {
        try {
            String sql = "INSERT INTO t_supplier (id_supplier, kd_pembelian, nama_supplier, nohp_supplier, alamat) VALUES ('"
                    + jTextField1.getText() + "','"
                    + jTextField2.getText() + "','"
                    + jTextField3.getText() + "','"
                    + jTextField4.getText() + "','"
            ...
            JOptionPane.showMessageDialog(null, "Supplier disimpan!");
            LoadDataSupplier();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal simpan supplier: " + e.getMessage());
        }
    }

    private void EditDataSupplier() {
        try {
            String sql = "UPDATE t_supplier SET kd_pembelian='"
                    + jTextField2.getText() + "', nama_supplier='"
                    + jTextField3.getText() + "', nohp_supplier='"
                    + jTextField4.getText() + "', alamat='"
                    + jTextField5.getText() + "' WHERE id_supplier='"
                    + jTextField1.getText() + "'";
            Statement st = Koneksi.con.createStatement();
            st.executeUpdate(sql);
            JOptionPane.showMessageDialog(null, "Supplier diupdate!");
            LoadDataSupplier();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal update supplier: " + e.getMessage());
        }
    }

    private void DeleteDataSupplier() {
        try {
            String sql = "DELETE FROM t_supplier WHERE id_supplier='" + jTextField1.getText() + "'";
            Statement st = Koneksi.con.createStatement();
            st.executeUpdate(sql);
            JOptionPane.showMessageDialog(null, "Supplier dihapus!");
            LoadDataSupplier();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal hapus supplier: " + e.getMessage());
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KelolaSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
