 ...
 * @author Pongo
 */
public class M4_Kubus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Form Perhitungan Kubus");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M4_Kubus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
