 ...
 * @author Pongo
 */
public class BP1_M4_T4_5_Rio extends javax.swing.JFrame {

    /**
     * Creates new form BP1_M4_P2_Rio_Register
     */
    public BP1_M4_T4_5_Rio() {
        initComponents();
    }
    ...
    private void simpan() {
    String nim, nama, jk, prodi, alamat, kelas, dpa, angkatan;
    ...
    if (nim.isEmpty() || nama.isEmpty()) {
        ...
        BP1_M4_T1_Rio fl = new BP1_M4_T1_Rio();
        fl.setVisible(true);
        return;
    }
    ...
    this.setVisible(false);
    BP1_M4_T3_Rio fn = new BP1_M4_T3_Rio();
    fn.setVisible(true);
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M4_T4_5_Rio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M4_T4_5_Rio().setVisible(true);
            }
        });
    }
