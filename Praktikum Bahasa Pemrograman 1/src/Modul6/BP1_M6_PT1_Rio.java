 ...
 * @author Pongo
 */
public class BP1_M6_PT1_Rio extends javax.swing.JFrame {
    private Object JTable1;
    Statement st;
    ResultSet rs;
    BP1_M6_P1_Rio BP1_M6_P1_Rio;
    public BP1_M6_PT1_Rio() {
        BP1_M6_P1_Rio k = new BP1_M6_P1_Rio();
        initComponents();
        load_data();
    }
    private void load_data(){
        Object header[] = {"Nim", "Nama", "Jenis Kelamin", "Prodi", "Alamat", "Kelas", "Angkatan", "No Telepon", "Kartu Mahasiswa"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        jTable1.setModel(data);
        String sql = "SELECT `nim`, `nama`, `jk`, `prodi`, `alamat`, `kelas`, `angkatan`, `notelpon`, `kartumhs` FROM `mahasiswa`";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M6_PT1_Rio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M6_PT1_Rio().setVisible(true);
            }
        });
    }
