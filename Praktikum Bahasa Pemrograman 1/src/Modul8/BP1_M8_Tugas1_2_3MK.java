 ...
 * @author Pongo
 */
public class BP1_M8_Tugas1_2_3MK extends javax.swing.JFrame {
    private Object JTable1;
    Statement st;
    ResultSet rs;
    BP1_M8_P1 BP1_M8_P1;
    public BP1_M8_Tugas1_2_3MK() {
        BP1_M8_P1 k = new BP1_M8_P1();
        initComponents();
        load_data();
    }
    private void load_data(){
        Object header[] = {"Kode Mata Kuliah", "Mata Kuliah", "SKS", "Dosen Pengampu"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        jTable1.setModel(data);
        String sql = "SELECT `kodemk`, `mk`, `sks`, `dosenp` FROM `matakuliah`";
        try{
    ...
    public void input_data(){
        try{
            ...
            String dosenp = jTextField4.getText();
            if (kodemk == 0  || namamk.isEmpty() || sks == 0 || dosenp.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Data harus Di Isi!", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            String sql = "INSERT INTO matakuliah (kodemk, mk, sks, dosenp) VALUES ('"
                + jTextField1.getText() + "','"
                + jTextField2.getText() + "','" 
                + jTextField3.getText() + "','" 
                + jTextField4.getText() + "')";
    ...
    private void update_data(){
        try{
            ...
            String sql_edit = "UPDATE matakuliah SET kodemk = '"
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Form Input Mata Kuliah");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (close == JOptionPane.NO_OPTION){
            JOptionPane.showMessageDialog(null, "Data Mata Kuliah Gagal Di Input");
            this.dispose();
        }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        int close = JOptionPane.showOptionDialog(this, "Apakah anda ingin mengupdate data?", "", JOptionPane.YES_NO_OPTION, 
                JOptionPane.QUESTION_MESSAGE, null, null, null);
        if (close == JOptionPane.YES_OPTION){
            JOptionPane.showMessageDialog(null, "Data Mata Kuliah Berhasil Di Update!");
            load_data();
        }
        if (close == JOptionPane.NO_OPTION){
            JOptionPane.showMessageDialog(null, "Data Mata Kuliah Gagal Di Update");
            this.dispose();
        }
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if (close == JOptionPane.NO_OPTION){
            JOptionPane.showMessageDialog(null, "Data Mata Kuliah Gagal Di Hapus");
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BP1_M8_Tugas1_2_3MK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BP1_M8_Tugas1_2_3MK().setVisible(true);
            }
        });
    }
